...
class DirectoryScalaInstallationTest {
  ...
  @Test
  def filenamesWithoutVersion_210(): Unit = {
  ...
  @Test
  def filenamesWithVersion_210(): Unit = {
    checkScalaInstallation(
  ...
  @Test
  def libraryCompilerCompatibleVersions_210(): Unit = {
    checkScalaInstallation(
  ...
  @Test
  def filenamesWithoutVersion_211(): Unit = {
    checkScalaInstallation(
        "lib/2.11.x/",
  ...
  @Test
  def filenamesWithVersion_211(): Unit = {
  ...
  @Test
  def libraryCompilerCompatibleVersions_211(): Unit = {
    checkScalaInstallation(
  ...
  def libraryCompilerIncompatibleVersions(): Unit = {
  ...
  def extraJarsIncompatibleVersions(): Unit = {
    checkScalaInstallation(
  ...
  @Test
  def mixedCompatibleVersionsWithSources(): Unit = {
